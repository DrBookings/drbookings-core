...
public class BookingBeanSer {
	...
	return "BookingBeanSer [bookingId=" + bookingId + ", checkInDate=" + checkInDate + ", checkOutDate="
		+ checkOutDate + ", cleaningFees=" + cleaningFees + ", grossEarningsExpression="
		+ grossEarningsExpression + ", guestName=" + guestName + ", paymentsSoFar=" + paymentsSoFar
		+ ", roomName=" + roomName + ", source=" + source + ", welcomeMailSend=" + welcomeMailSend + "]";
    }
