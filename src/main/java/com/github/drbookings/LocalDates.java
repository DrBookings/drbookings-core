...
public class LocalDates {
    ...
    public static String getWeekDayString(final LocalDate date) {
	return date.format(DateTimeFormatter.ofPattern("EE"));
    }

    public static String getDayOfMonthString(final LocalDate date) {
	return date.format(DateTimeFormatter.ofPattern("dd"));
    }

    public static String getMonthString(final LocalDate date) {
	return date.format(DateTimeFormatter.ofPattern("MMM"));
    }

    public static TextFlow getDateText(final LocalDate date) {
	final TextFlow tf = new TextFlow();
	final Text t0 = new Text(
		String.format("%3s\t%3s %3s", getWeekDayString(date), getDayOfMonthString(date), getMonthString(date)));
    ...
    public static Range<LocalDate> toDateRange(final Collection<? extends LocalDate> dates) {
