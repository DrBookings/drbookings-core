...
public abstract class NamedFactory<T extends Named> {

    private static final Logger logger = LoggerFactory.getLogger(NamedFactory.class);
	...
	if (!(obj instanceof NamedFactory)) {
	    return false;
	}
	final NamedFactory other = (NamedFactory) obj;
	if (elements == null) {
